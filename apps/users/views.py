...
from .forms import LoginForm, RegisterForm, ForgetForm, ModifyPwdForm, UpLoadForm, UserInfoForm
...
class UpLoadImageView(LoginRequiredMixin, View):
    ...
    def post(self, request):
        ...
        #     image = image_form.clean_data
        #     request.user.image = image
        #     request.user.save()

        # 方法2
        image_form = UpLoadForm(request.POST, request.FILES, instance=request.user)
        if image_form.is_valid():
            request.user.save()
